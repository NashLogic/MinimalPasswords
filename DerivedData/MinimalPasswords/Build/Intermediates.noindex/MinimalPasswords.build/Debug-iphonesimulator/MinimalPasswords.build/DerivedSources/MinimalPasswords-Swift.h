...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MinimalPasswords",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16MinimalPasswords11AppDelegate")
...
SWIFT_CLASS("_TtC16MinimalPasswords12CustomButton")
...
SWIFT_CLASS("_TtC16MinimalPasswords27ListPasswordsViewController")
...
@interface ListPasswordsViewController (SWIFT_EXTENSION(MinimalPasswords)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC16MinimalPasswords19LoginViewController")
...
SWIFT_CLASS("_TtC16MinimalPasswords22MainMenuViewController")
...
SWIFT_CLASS("_TtC16MinimalPasswords24MainNavigationController")
...
SWIFT_CLASS("_TtC16MinimalPasswords12PasswordCell")
...
SWIFT_CLASS("_TtC16MinimalPasswords13SceneDelegate")
...
SWIFT_CLASS("_TtC16MinimalPasswords14ViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified passwordLength;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified textField;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified switchatozOutlet;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified switchAtoZOutlet;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified switch0to9Outlet;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified switchSymbolsOutlet;
- (void)viewDidLoad;
- (void)dismissKeyboard;
- (IBAction)savePassword:(id _Nonnull)sender;
- (IBAction)switchatoz:(id _Nonnull)sender;
- (IBAction)switchAtoZ:(id _Nonnull)sender;
- (IBAction)switch0to9:(id _Nonnull)sender;
- (IBAction)switchSymbolsOutlet:(id _Nonnull)sender;
- (IBAction)generateButton:(id _Nonnull)sender;
- (IBAction)clearButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
